...
public class Customer {
    ...
    public String getCust_realimage() {
        return cust_realimage;
    }

    public void setCust_realimage(String cust_realimage) {
        this.cust_realimage = cust_realimage;
    }
